...
void main() async {
  ...
  await updateOfficialAddresses();
}

Future<void> updateOfficialAddresses() async {
  ...
  try {
    ...
    try {
      ...
      print('✅ Added address column to officials table');
    } catch (e) {
      print('ℹ️ Address column already exists or error: $e');
    }
