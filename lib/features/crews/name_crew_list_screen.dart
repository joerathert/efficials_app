...
class NameCrewListScreen extends StatefulWidget {
  const NameCrewListScreen({super.key});

  @override
  State<NameCrewListScreen> createState() => _NameCrewListScreenState();
}

class _NameCrewListScreenState extends State<NameCrewListScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: textFieldDecoration('Ex. Varsity $sport Crews'),
