...
class _BackoutNotificationsScreenState extends State<BackoutNotificationsScreen> with SingleTickerProviderStateMixin {
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () => _showDeleteDialog(notification),
                  child: Container(
  ...
  void _showDeleteDialog(models.Notification notification) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
  ...
  Future<void> _deleteNotification(models.Notification notification) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Notification deleted', style: TextStyle(color: Colors.black)),
            backgroundColor: efficialsYellow,
            duration: Duration(seconds: 2),
          ),
        );
