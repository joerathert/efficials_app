    ...
    try {
      ...
      for (var game in allGames) {
        if (game['scheduleName'] != null) {
          final scheduleName = game['scheduleName'] as String? ?? 'Unknown Schedule';
          scheduleNameSet.add(scheduleName);
  ...
  Future<void> _processScheduleGrouping(
    ...
    for (var scheduleName in scheduleNameSet) {
      if (scheduleDetails.containsKey(scheduleName)) {
        ...
        final sport = details['sport'] as String? ?? 'Unknown';
        final gender = details['gender'] as String? ?? 'Unknown';
