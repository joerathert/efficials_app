// Generated officials data from CSV for quick access buttons
// Format: J. Smith style names with email addresses
...
Certified,17,Wooten,Edward,801 Chancellor Dr,Edwardsville,62025,618-560-1502''';
    ...
    for (final line in lines) {
      ...
      if (parts.length >= 4) {
        // Format: Level of Certification,Years of Experience,Last Name,First Name,...
