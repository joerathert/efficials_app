...
import 'advanced_officials_selection_screen.dart'; // Add this import
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/advanced_officials_selection': (context) => const AdvancedOfficialsSelectionScreen(), // Add this route
      },
    );
  }
}