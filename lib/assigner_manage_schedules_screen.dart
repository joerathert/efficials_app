...
class _AssignerManageSchedulesScreenState
  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      if (args['selectedTeam'] != null && _teamToRestore == null) {
        ...
        print(
            'AssignerManageSchedules - Captured team to restore: $_teamToRestore');
      }
      if (args['focusDate'] != null && _dateToFocus == null) {
        _dateToFocus = args['focusDate'] as DateTime;
        print(
            'AssignerManageSchedules - Captured date to focus: $_dateToFocus');
      }
    }
  }
  ...
  Future<void> _loadAssignerInfo() async {
    ...
    if (_teamToRestore != null) {
      print(
          'AssignerManageSchedules - Restoring team selection after load: $_teamToRestore');
      print('AssignerManageSchedules - Available teams: $teams');

      if (teams.contains(_teamToRestore)) {
        print(
            'AssignerManageSchedules - Team found in _loadAssignerInfo, setting selection');
        ...
        print(
            'AssignerManageSchedules - Team $_teamToRestore NOT found in teams list: $teams');
      }
    }
  ...
  Future<void> _fetchGames() async {
    print(
        'AssignerManageSchedules - _fetchGames called for team: $selectedTeam');
    ...
    print(
        'AssignerManageSchedules - Filtering games for team: $selectedTeam, sport: $assignerSport');
    print(
        'AssignerManageSchedules - Total games before filtering: ${allGames.length}');
    games = allGames.where((game) {
      ...
      if (shouldInclude) {
        print(
            'AssignerManageSchedules - Including game: ${game['opponent']} vs ${game['scheduleName']} (${game['sport']})');
      }

      return shouldInclude;
    }).toList();
    print(
        'AssignerManageSchedules - Games found for $selectedTeam: ${games.length}');
  ...
  Future<void> _loadAssociatedTemplate() async {
    ...
    if (templateJson != null) {
      ...
      print(
          'AssignerManageSchedules - Template name set to: $associatedTemplateName');
    } else {
      if (mounted) {
        setState(() {
      ...
      print(
          'AssignerManageSchedules - No template found, clearing template name');
    }
  }
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              onChanged: (newValue) async {
                                if (newValue == '+ Add a new team') {
                                  ...
                                  print(
                                      'AssignerManageSchedules - Team dropdown changed to: $newValue');
                                  if (mounted) {
                                    setState(() {
